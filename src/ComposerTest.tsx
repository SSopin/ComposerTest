...
export function ComposerTest ({canvas}: Props) {
    ...
    const camera = useMemo(() => new THREE.PerspectiveCamera( 45, width / height, 10, 200 ), []);
    ...
    return (
        <div >
            <div style={{position: 'absolute', top: 0, left: 0, right: 0, fontSize: '36pt'}}>{'AVG FPS: ' + avgFps.fps / avgFps.measurements}</div>
        </div>
    )
}
